<?php
/**
 * Geritcht\Geritcht\Image_Sizes\Component class
 *
 * @package geritcht
 */

namespace Geritcht\Geritcht\Image_Sizes;

use Geritcht\Geritcht\Component_Interface;
use function Geritcht\Geritcht\geritcht;
use WP_Post;
...
class Component implements Component_Interface {
	...
	public function filter_content_image_sizes_attr( string $sizes, array $size ) : string {
		...
		if ( geritcht()->is_primary_sidebar_active() ) {
