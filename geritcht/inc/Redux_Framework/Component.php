...
namespace Geritcht\Geritcht\Redux_Framework;
...
class Component implements Component_Interface {
	...
	protected $opt_name = "geritcht-options";
	/**
	...
	public function action_add_redux(){
		...
		$args = array(
			...
			'menu_title'           => esc_html__( 'Geritcht Design','geritcht'),
			'page_title'           => esc_html__( 'Geritcht Design','geritcht'),
