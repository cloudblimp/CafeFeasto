<?php
/**
 * Geritcht\Geritcht\Nav_Menus\Component class
 *
 * @package geritcht
 */

namespace Geritcht\Geritcht\Nav_Menus;
 ...
 * * `geritcht()->is_primary_nav_menu_active()`
 * * `geritcht()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'geritcht' ),
			)
		);
	}
